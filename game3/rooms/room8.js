function roomEight()
{
    ...
    this.enemies = [new Enemy(width / 2, height / 2), new Enemy(width / 2, 50), new Enemy(30, height / 2 - height / 5), new Enemy(30, height / 2 + height / 5), new Enemy(width / 2, height - 50)];
