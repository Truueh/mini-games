function roomFourteen()
{
    this.toShow = false;
    this.discovered = false;
    this.doorLocked = true;
    this.enemies = [new Enemy(30, 50), new Enemy(width - 30, 50), new Enemy(30, height - 50), new Enemy(width - 30, height - 50), new Enemy(width / 2, height / 2)];
